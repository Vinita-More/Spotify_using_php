...
$CATEGORY_MAP = [
    "health%252520%2526%252520fitness" => "Health & Fitness",
    "religion%252520%2526%252520spirituality" => "Religion & Spirituality",
    "society%252520%2526%252520culture" => "Society & Culture",
    "true%252520crime" => "True Crime",
    "tv%252520%2526%252520film" => "TV & Film"
];
...
echo "[INFO] Table 'spotify_charts_$timestamp' created successfully.\n";
...
foreach ($countries as $country) {
    ...
    foreach ($categories as $category) {
        ...
        foreach ($items as $item) {
            ...
            $categoryName = $CATEGORY_MAP[$category] ?? ucfirst($category);
...
echo "[DONE] Completed fetching and inserting podcast charts into table 'spotify_charts_$timestamp'.\n";
?>
